// package tlscert provides a quick and dirty way to generate self-signed certificates,
// perfect to do quick test for HTTP/2. The whole code is based on https://golang.org/src/crypto/tls/generate_cert.go
package tlscert
...
func GenerateCert(path string) {
	...
	certOut.Close()
	log.Print(path, "/cert.pem created\n")
